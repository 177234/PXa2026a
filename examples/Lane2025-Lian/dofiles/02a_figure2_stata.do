...
// args supplied_output_root
// if `"`supplied_output_root'"' == "" {
//     local output_root "`c(pwd)'"
// }
// else {
//     local output_root `"`supplied_output_root'"'
// }
dis "`output_root'"

local source_root ///
    "`output_root'/Lane_2025_QJE_paper_codes/replicationpackage"
