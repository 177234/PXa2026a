...
Original script: Lane2025QJE/replicationpackage/setup/setup.do
Purpose: Stata environment setup and dependency installation.
...
archived at: markdown_notes_archive/setup_do.md
