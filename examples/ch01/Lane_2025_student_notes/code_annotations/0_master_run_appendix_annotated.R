...
# Original script: Lane2025QJE/replicationpackage/code/3_appendix/0_master_run_appendix.R
# Purpose: R dispatcher for appendix figures and tables.
#
...
# archived at: markdown_notes_archive/0_master_run_appendix_R.md
#
# Audit linkage:
